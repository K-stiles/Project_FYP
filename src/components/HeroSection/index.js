    ...
    <>
      <HeroTopSection>
        <HeroInfo>
          ...
          <HeroDescription>
            Every GraphQL server including Apollo Server uses a schema to define
            the structure of data that clients can query. In this example, we'll
            create a server for querying a collection of books by title and
            author.
          </HeroDescription>
          <PrimarySolidBtn>Get Started</PrimarySolidBtn>
        </HeroInfo>
