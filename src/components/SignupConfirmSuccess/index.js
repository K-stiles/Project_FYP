...
SuccessConfirmSignup.BtnLink = function SuccessConfirmSignupBtnLink({
   children,
   ...restProps
}) {
...
SuccessConfirmSignup.FBSocialIconWrapper =
   function SuccessConfirmSignupFBSocialIconWrapper({
      children,
      ...restProps
   }) {
      return (
         <FBSocialIconWrapper {...restProps}>{children}</FBSocialIconWrapper>
      );
   };
