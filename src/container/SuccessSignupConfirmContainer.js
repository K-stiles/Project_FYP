         ...
         <SuccessConfirmSignup.Container>
            <SuccessConfirmSignup.Form>
               ...
               <SuccessConfirmSignup.Info>
                  ...
                  safely.Input your new desired password in the input fields
                  below to create a new password. We strongly advise you to
                  store it safely.
               </SuccessConfirmSignup.Info>

               <SuccessConfirmSignup.SuccessButton>
                  <SuccessConfirmSignup.BtnLink to={"/login"}>
                     Go to Login
